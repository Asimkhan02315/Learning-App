...
function DrawerContainer({ navigation, state }) {
        ...
        <View style={{ flex: 1 }}>
            ...
            {searchEnable == false && (
                <View style={[styles.content, { backgroundColor: '#fff' }]}>
                    <View style={[styles.view, { backgroundColor: '#D7EEFD' }]}>
                        <TouchableOpacity onPress={closeDrawer} style={styles.closeButton}>
                            <Icon name="close" size={24} color="#160B5C" />
                        </TouchableOpacity>
                        <Svg xmlns="http://www.w3.org/2000/svg" width="250" height="20" viewBox="0 0 51 12" fill="none">
                        ...
                        <TouchableOpacity onPress={navigateToSearchPage} style={styles.searchButton}>
                            <Icon name="search" size={24} color="#160B5C" />
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: "row", margin: 10 }}>
                        <FastImage style={{ width: 60, height: 60, borderRadius: 60 }}
                            source={AppIcon.images.logo} />
                        <View style={{ marginLeft: 15, marginTop: 5 }}>
                            <Text style={{ color: '#160B5C', fontWeight: 'bold', fontSize: 20 }}>
                                {userProfile.name}
                            </Text>
                            <Text style={{ color: '#160B5C', fontSize: 15, fontWeight: 500 }}>{userProfile.email}</Text>
                        </View>
                    </View>
                    <View style={styles.container}>
                        ...
                        <List.Section style={{ width: '100%' }}>
                            <List.Accordion
                                title="Upskills Collection"
                                left={(props) => <List.Icon {...props} icon="book" color="#0E2254" />}
                                active={state.index === 1 ? true : false}
                                titleStyle={{ color: '#0E2254', fontWeight: 'bold' }}
                            >
                                <List.Item
                                    left={(props) => <List.Icon {...props} icon="certificate" color="#0E2254" />}
                                    title="Courses"
                                    onPress={navigateToUpskills}
                                    style={{ marginRight: 110, padding: 40 }}
                                    titleStyle={{ color: '#0E2254', fontWeight: 'bold' }}
                                />
                            </List.Accordion>
                        </List.Section>
                    ...
                    <View style={styles.bottomText}>
                        <Svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                            <Path d="M10.7149 16.5407C10.7147 16.5735 10.7059 16.6057 10.6893 16.6341C10.6728 16.6624 10.6491 16.6859 10.6206 16.7022C10.5921 16.7184 10.5599 16.7269 10.5272 16.7267C10.4944 16.7266 10.4623 16.7178 10.434 16.7012L4.78715 13.4292C4.75141 13.4085 4.72201 13.3784 4.70219 13.3421C4.68237 13.3059 4.67289 13.2648 4.67478 13.2235V6.97939C4.67261 6.92545 4.6498 6.87442 4.61108 6.8369C4.57236 6.79939 4.52072 6.77828 4.46689 6.77796H0.202274C0.149384 6.77683 0.0990076 6.75511 0.0618058 6.7174C0.0241617 6.67998 0.00207368 6.62965 0 6.57654V0.208466C0.000734219 0.153163 0.0230647 0.100353 0.0621969 0.0613766C0.101329 0.0223998 0.154143 0.00036382 0.209297 0H15.4023C15.4575 0.00036382 15.5103 0.0223998 15.5494 0.0613766C15.5886 0.100353 15.6109 0.153163 15.6116 0.208466V6.56809C15.6101 6.62133 15.5879 6.67187 15.5498 6.70894C15.5125 6.74669 15.4623 6.76884 15.4094 6.77092H13.4709C13.417 6.77055 13.3654 6.74892 13.3273 6.71069C13.2892 6.67247 13.2676 6.62073 13.2672 6.56668V3.4411C13.2673 3.39024 13.2494 3.34099 13.2168 3.30206C13.1841 3.26314 13.1388 3.23705 13.0888 3.22841L7.67518 2.30439C7.64896 2.30278 7.62294 2.30978 7.60104 2.32433C7.57915 2.33888 7.56258 2.36019 7.55385 2.38503C7.54512 2.40986 7.54469 2.43688 7.55265 2.46198C7.5606 2.48708 7.57649 2.5089 7.59792 2.52413L10.5983 4.17214C10.6344 4.1919 10.6645 4.2211 10.6854 4.25665C10.7865 4.38906 10.6798 16.3984 10.7149 16.5407Z" fill="#EA472A" />
                        </Svg><Text style={styles.btmText}>D</Text>
