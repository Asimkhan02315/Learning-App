...
const WelcomeScreen = () => {
    ...
    return (
        <View style={styles.container}>
            {showInput ? (
                <Text style={styles.titleAboveSvg}>Welcome to</Text>
            ) : (
            ...
            {showInput && (
                <View style={styles.inputContainer}>
                    <Text style={styles.titleText}> Oraganisation ID </Text>
                    <TextInput
                        style={styles.input}
                        placeholder="Oraganisation ID"
                    />
                    <TouchableOpacity onPress={handleConfirmClick} style={styles.confirmBtn}>
