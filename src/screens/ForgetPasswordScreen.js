...
function ForgetPasswordScreen({ navigation }) {
    ...
    return (
        <View style={globalStyles.container}>
            <Text style={[globalStyles.title, { marginTop: 150, marginBottom: 30 }]}>Welcome to</Text>
            <Svg
                width="102"
                height="100"
                viewBox="0 0 102 110"
            ...
            <Text style={[globalStyles.title, { marginTop: 70, marginBottom: 30 }]}>Forgot Password </Text>
            <Controller
                control={control}
                name="email"
            ...
            <View style={globalStyles.linkView}>
                <Link to={{ screen: 'LoginScreen' }}>
                    <Text style={globalStyles.linkStyle}>Login</Text>
                </Link>
            </View>
            <Snackbar
                visible={visible}
